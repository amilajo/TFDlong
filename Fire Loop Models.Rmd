...
```{r change function, results = 'asis', echo = T, dev = c('pdf', 'png'), fig.path = "figure/", dpi = 300, fig.width = 8, fig.height = 11}
...
plotlist.a <- list(orig.resid, trans.resid, qq.plot.orig, qq.plot.trans, 
                   cd.plot.orig, cd.plot.trans)
plotlist.b <- list(fbeta1$`(Intercept)`$plot, 
                   paste0("fbeta1$",out_info$pfasmdl$terms[[3]][[2]],"$plot", sep = ""), 
                   fbeta1$EthnicityHispanic$plot, 
                   fbeta2$`(Intercept)`$plot, 
                   paste0("fbeta2$",out_info$transmdl$terms[[3]][[2]],"$plot", sep = ""),
                   fbeta2$EthnicityHispanic$plot)

print(ggarrange(plotlist = plotlist.a, nrow = 5, ncol = 2))
...
```{r CD plots, results = 'asis', echo = T, dev = c('pdf', 'png'), fig.path = "figure/", eval = F}
...
for (i in 1:length(pfas.list)) {
  ...
  for (fire.var in fire.list) {
    ...
    print(ggarrange(plotlist = CDplots,
...
```{r DFBETA plots, results = 'asis', echo = T, dev = c('pdf', 'png'), fig.path = "figure/", eval = F}
...
for (i in 1:length(pfas.list)) {
  ...
  for (fire.var in fire.list) {
   ...
   #DFBETA plots
            ...
            print(ggarrange(plotlist = FBplots))
